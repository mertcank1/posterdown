...
After determining class numbers, latent class models were estimated using the Bayesian approach with binary in Table \@ref(tab:mytable3) and multi-category datasets in Table \@ref(tab:mytable4).
